...
public class TransferServiceImpl implements TransferService {
    ...
    private static final List<String> PAYMENT_MODES = List.of("NEFT", "IMPS", "RTGS", "UPI");
    ...
    public void transfer(double amount, String fromAccountNumber, String toAccountNumber) {
        ...
        // ===== Cassandra: Save transaction history (uncomment when Cassandra is enabled) =====
        ...
        // logger.info("Saved withdrawal to Cassandra for account: {}", fromAccountNumber);
        //
        ...
        // Key = fromAccount-toAccount => distributes across partitions
        // Different account pairs hash to different partitions
        String key = fromAccountNumber + "-" + toAccountNumber;
